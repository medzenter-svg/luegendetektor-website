...
export default function LuegendetekorKoeln() {
  useEffect(() => {

    // Meta tags
    document.title = "Lügendetektor Test Köln – Polygraph | luegendetektor-test-muenchen.de";
    ...
    setMeta("description", "Professionelle Lügendetektor-Tests in Köln. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.");
    setMeta("og:title", "Lügendetektor Test Köln – Polygraph | luegendetektor-test-muenchen.de", true);
    setMeta("og:description", "Professionelle Lügendetektor-Tests in Köln. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.", true);
    setMeta("og:url", "https://luegendetektor-test-muenchen.de/luegendetektor-koeln", true);
    ...
    setMeta("twitter:title", "Lügendetektor Test Köln – Polygraph | luegendetektor-test-muenchen.de");
    setMeta("twitter:description", "Professionelle Lügendetektor-Tests in Köln. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.");
    setLink("canonical", "https://luegendetektor-test-muenchen.de/luegendetektor-koeln");
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute("content", "Professionelle Polygraphuntersuchungen in Köln, Bonn und der Region. Diskret, zertifiziert, für Privat & Unternehmen. Kostenlose Erstberatung.");
    const schema = document.createElement("script");
    schema.type = "application/ld+json";
    schema.text = JSON.stringify({
      "@context": "https://schema.org", "@type": "Service",
      "name": "Polygraphuntersuchung Köln",
    ...
    const citySchema = {
      ...
      "@id": "https://luegendetektor-test-muenchen.de/luegendetektor-koeln#business",
      "name": "Lügendetektor Test Köln – Polygraph Untersuchungen",
      "description": "Professionelle Polygraphuntersuchungen in Köln. Diskreter Lügendetektor-Test mit offiziellem Gutachten.",
      "url": "https://luegendetektor-test-muenchen.de/luegendetektor-koeln",
    ...
    { label: "Lügendetektor Köln" }
      ...
      <section style={{ background: `linear-gradient(135deg, ${NAVY} 0%, #243d6b 100%)`, padding: "72px 24px 56px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <p style={{ color: ORANGE, fontSize: "12px", fontWeight: 700, letterSpacing: "2.5px", textTransform: "uppercase", marginBottom: "18px" }}>Köln, Bonn & Rheinland</p>
          <h1 style={{ color: WHITE, fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 800, lineHeight: 1.15, marginBottom: "20px" }}>
            Lügendetektor-Test in Köln
          </h1>
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "18px", lineHeight: 1.75, maxWidth: "640px", marginBottom: "36px" }}>
            Professionelle Polygraphuntersuchungen für Privatpersonen und Unternehmen in Köln, Bonn und der gesamten Rheinregion.
          </p>
      ...
      <section style={{ backgroundColor: WHITE, padding: "56px 24px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <h2 style={{ color: NAVY, fontSize: "22px", fontWeight: 700, marginBottom: "14px" }}>Untersuchungen in Köln und Umgebung</h2>
          <p style={{ color: TEXT_MID, fontSize: "17px", lineHeight: 1.95, marginBottom: "24px" }}>
            Köln ist einer der größten Medien-, Versicherungs- und Handelsstandorte Deutschlands. Unsere Spezialisten sind mit den spezifischen Anforderungen von Unternehmen und Privatpersonen in der Domstadt vertraut.
          </p>
          <p style={{ color: TEXT_MID, fontSize: "17px", lineHeight: 1.95, marginBottom: "40px" }}>
            Wir kommen zu Ihnen nach Köln oder Sie besuchen uns in München. Für Unternehmen bieten wir Untersuchungen direkt vor Ort an – diskret und ohne öffentliche Spuren.
          </p>
          ...
          <div style={{ backgroundColor: NAVY, borderRadius: "10px", padding: "36px 32px", marginBottom: "40px" }}>
            <h3 style={{ color: WHITE, fontSize: "19px", fontWeight: 700, marginBottom: "10px" }}>Anfrage für Köln</h3>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
            {[{ city: "München", link: "/" }, { city: "Berlin", link: "/luegendetektor-berlin" }, { city: "Hamburg", link: "/luegendetektor-hamburg" }, { city: "Frankfurt", link: "/luegendetektor-frankfurt" }, { city: "Düsseldorf", link: "/luegendetektor-duesseldorf" }, { city: "Stuttgart", link: "/luegendetektor-stuttgart" }, { city: "Wien", link: "/polygraph-wien" }, { city: "Zürich", link: "/polygraph-zuerich" }].map((item) => (
      ...
      <ContactFormCompact context="Lügendetektor Köln" />
      <SharedFooter />
      <FloatingButtons />
    </div>
  );
