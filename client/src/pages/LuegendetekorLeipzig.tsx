...
export default function LuegendetekorLeipzig() {
  useEffect(() => {

    // Meta tags
    document.title = "Lügendetektor Test Leipzig – Polygraph | luegendetektor-test-muenchen.de";
    ...
    setMeta("description", "Professionelle Lügendetektor-Tests in Leipzig. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.");
    setMeta("og:title", "Lügendetektor Test Leipzig – Polygraph | luegendetektor-test-muenchen.de", true);
    setMeta("og:description", "Professionelle Lügendetektor-Tests in Leipzig. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.", true);
    setMeta("og:url", "https://luegendetektor-test-muenchen.de/luegendetektor-leipzig", true);
    ...
    setMeta("twitter:title", "Lügendetektor Test Leipzig – Polygraph | luegendetektor-test-muenchen.de");
    setMeta("twitter:description", "Professionelle Lügendetektor-Tests in Leipzig. Polygraphuntersuchung mit offiziellem Gutachten – diskret, zertifiziert, bundesweit.");
    setLink("canonical", "https://luegendetektor-test-muenchen.de/luegendetektor-leipzig");
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute("content", "Professionelle Polygraphuntersuchungen in Leipzig und Sachsen. Diskret, zertifiziert, für Privat & Unternehmen. Kostenlose Erstberatung.");
    window.scrollTo(0, 0);
    ...
    const citySchema = {
      ...
      "@id": "https://luegendetektor-test-muenchen.de/luegendetektor-leipzig#business",
      "name": "Lügendetektor Test Leipzig – Polygraph Untersuchungen",
      "description": "Professionelle Polygraphuntersuchungen in Leipzig. Diskreter Lügendetektor-Test mit offiziellem Gutachten.",
      "url": "https://luegendetektor-test-muenchen.de/luegendetektor-leipzig",
    ...
    { label: "Lügendetektor Leipzig" }
      ...
      <section style={{ background: `linear-gradient(135deg, ${NAVY} 0%, #243d6b 100%)`, padding: "72px 24px 56px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <p style={{ color: ORANGE, fontSize: "12px", fontWeight: 700, letterSpacing: "2.5px", textTransform: "uppercase", marginBottom: "18px" }}>Leipzig & Sachsen</p>
          <h1 style={{ color: WHITE, fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 800, lineHeight: 1.15, marginBottom: "20px" }}>
            Lügendetektor-Test in Leipzig
          </h1>
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "18px", lineHeight: 1.75, maxWidth: "640px", marginBottom: "36px" }}>
            Professionelle Polygraphuntersuchungen für Privatpersonen und Unternehmen in Leipzig, Dresden und ganz Sachsen.
          </p>
      ...
      <section style={{ backgroundColor: WHITE, padding: "56px 24px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <h2 style={{ color: NAVY, fontSize: "22px", fontWeight: 700, marginBottom: "14px" }}>Untersuchungen in Leipzig und Sachsen</h2>
          <p style={{ color: TEXT_MID, fontSize: "17px", lineHeight: 1.95, marginBottom: "24px" }}>
            Leipzig hat sich in den letzten Jahren zu einem der dynamischsten Wirtschaftsstandorte Ostdeutschlands entwickelt. Unsere Spezialisten kommen zu Ihnen nach Leipzig oder Sie besuchen uns in München.
          </p>
          <p style={{ color: TEXT_MID, fontSize: "17px", lineHeight: 1.95, marginBottom: "40px" }}>
            Wir decken die gesamte Region Sachsen ab – einschließlich Dresden, Chemnitz und dem Umland. Für Unternehmen bieten wir Untersuchungen direkt vor Ort an.
          </p>
          ...
          <div style={{ backgroundColor: NAVY, borderRadius: "10px", padding: "36px 32px", marginBottom: "40px" }}>
            <h3 style={{ color: WHITE, fontSize: "19px", fontWeight: 700, marginBottom: "10px" }}>Anfrage für Leipzig</h3>
      ...
      <ContactFormCompact context="Lügendetektor Leipzig" />
      <SharedFooter />
      <FloatingButtons />
    </div>
  );
