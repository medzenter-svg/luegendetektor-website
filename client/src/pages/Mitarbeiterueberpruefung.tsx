...
export default function Mitarbeiterueberpruefung() {
  useEffect(() => {
    ...
    // Meta tags
    document.title = "Mitarbeiterüberprüfung Polygraph München | luegendetektor-test-muenchen.de";
    ...
    setMeta("description", "Polygraphbasierte Mitarbeiterüberprüfung für Unternehmen. Diskret, rechtssicher, mit offiziellem Gutachten. Bundesweit verfügbar – täglich 10–22 Uhr.");
    setMeta("og:title", "Mitarbeiterüberprüfung Polygraph München | luegendetektor-test-muenchen.de", true);
    setMeta("og:description", "Polygraphbasierte Mitarbeiterüberprüfung für Unternehmen. Diskret, rechtssicher, mit offiziellem Gutachten. Bundesweit verfügbar – täglich 10–22 Uhr.", true);
    setMeta("og:url", "https://luegendetektor-test-muenchen.de/mitarbeiterueberpruefung", true);
    ...
    setMeta("twitter:title", "Mitarbeiterüberprüfung Polygraph München | luegendetektor-test-muenchen.de");
    setMeta("twitter:description", "Polygraphbasierte Mitarbeiterüberprüfung für Unternehmen. Diskret, rechtssicher, mit offiziellem Gutachten. Bundesweit verfügbar – täglich 10–22 Uhr.");
    setLink("canonical", "https://luegendetektor-test-muenchen.de/mitarbeiterueberpruefung");
  ...
  [
    ...
    { label: "Mitarbeiterüberprüfung" }
      ...
      <section style={{ backgroundColor: LIGHT_BG, padding: "60px 24px" }}>
        ...
        items={[
        { title: "Polygraph für Unternehmen", excerpt: "Einsatzmöglichkeiten des Polygraphen im Unternehmenskontext – von der Einstellung bis zur internen Ermittlung.", href: "/ratgeber/polygraph-fuer-unternehmen", type: "ratgeber" as const },
        { title: "Mitarbeiterdiebstahl aufklären", excerpt: "Wie der Polygraph bei der Aufklärung von Diebstahl und Unterschlagung helfen kann.", href: "/ratgeber/mitarbeiterdiebstahl", type: "ratgeber" as const },
        { title: "Interne Ermittlungen", excerpt: "Diskrete Untersuchung von Vertrauensbrüchen, Datenmissbrauch und internen Konflikten.", href: "/interne-ermittlungen", type: "leistung" as const }
        ]}
      />
      <ContactFormCompact context="Mitarbeiterüberprüfung" />
      <SharedFooter />
      <FloatingButtons />
    </div>
  );
