...
export default function RatgeberPolygraphVsStresstest() {
  useEffect(() => {
    ...
    // Meta tags
    document.title = "Polygraph vs. Stresstest – Unterschiede erklärt | luegendetektor-test-muenchen.de";
    ...
    setMeta("description", "Was unterscheidet einen Polygraphen von einem Stresstest? Methoden, Aussagekraft und Einsatzgebiete im direkten Vergleich.");
    setMeta("og:title", "Polygraph vs. Stresstest – Unterschiede erklärt | luegendetektor-test-muenchen.de", true);
    setMeta("og:description", "Was unterscheidet einen Polygraphen von einem Stresstest? Methoden, Aussagekraft und Einsatzgebiete im direkten Vergleich.", true);
    setMeta("og:url", "https://luegendetektor-test-muenchen.de/ratgeber/polygraph-vs-stresstest", true);
    ...
    setMeta("twitter:title", "Polygraph vs. Stresstest – Unterschiede erklärt | luegendetektor-test-muenchen.de");
    setMeta("twitter:description", "Was unterscheidet einen Polygraphen von einem Stresstest? Methoden, Aussagekraft und Einsatzgebiete im direkten Vergleich.");
    setLink("canonical", "https://luegendetektor-test-muenchen.de/ratgeber/polygraph-vs-stresstest");
