...
export default function Sicherheitspruefung() {
  useEffect(() => {
    ...
    // Meta tags
    document.title = "Sicherheitsprüfung Polygraph München | luegendetektor-test-muenchen.de";
    ...
    setMeta("description", "Polygraphbasierte Sicherheitsprüfung für sensible Positionen. Zuverlässige Überprüfung von Vertrauenswürdigkeit und Integrität. Bundesweit verfügbar.");
    setMeta("og:title", "Sicherheitsprüfung Polygraph München | luegendetektor-test-muenchen.de", true);
    setMeta("og:description", "Polygraphbasierte Sicherheitsprüfung für sensible Positionen. Zuverlässige Überprüfung von Vertrauenswürdigkeit und Integrität. Bundesweit verfügbar.", true);
    setMeta("og:url", "https://luegendetektor-test-muenchen.de/sicherheitspruefung", true);
    ...
    setMeta("twitter:title", "Sicherheitsprüfung Polygraph München | luegendetektor-test-muenchen.de");
    setMeta("twitter:description", "Polygraphbasierte Sicherheitsprüfung für sensible Positionen. Zuverlässige Überprüfung von Vertrauenswürdigkeit und Integrität. Bundesweit verfügbar.");
    setLink("canonical", "https://luegendetektor-test-muenchen.de/sicherheitspruefung");
  ...
  [
    ...
    { label: "Sicherheitsprüfung" }
      ...
      <section style={{ backgroundColor: WHITE, padding: "60px 24px" }}>
        ...
        items={[
        { title: "IT-Sektor Überprüfung", excerpt: "Spezialisierte Untersuchungen bei Datenlecks, Industriespionage und Zugangsmissbrauch.", href: "/it-sektor", type: "leistung" as const },
      ...
      />
      <ContactFormCompact context="Sicherheitsprüfung" />
      <SharedFooter />
      <FloatingButtons />
    </div>
  );
